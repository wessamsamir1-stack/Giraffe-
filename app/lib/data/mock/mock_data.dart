...
class Mock {
  ...
  static const myPs5 = Item(
    id: 'i_ps5',
    ownerId: 'u_me',
    titleAr: 'بلايستيشن 5 سليم مع دراعين',
    titleEn: 'PlayStation 5 Slim with 2 controllers',
    categoryId: 'gaming',
    ...
    brand: 'Sony',
    model: 'PS5 Slim 1TB',
    descriptionAr: 'استعمال خفيف جداً، بالكرتونة والضمان. معاه لعبتين.',
    descriptionEn: 'Very light use, boxed with warranty. Includes 2 games.',
    photoCount: 4,
    imageSeed: 11,
    interestedCount: 14,
    wishlistCount: 38,
  ...
  static const myLens = Item(
    id: 'i_lens',
    ownerId: 'u_me',
    titleAr: 'عدسة كانون 50mm f/1.8',
    titleEn: 'Canon 50mm f/1.8 lens',
    categoryId: 'cameras',
    ...
    descriptionAr: 'شغالة تمام، فيها خدش بسيط في البودي مش مؤثر.',
    descriptionEn: 'Works perfectly, minor cosmetic scratch on the body.',
    photoCount: 3,
    imageSeed: 12,
    interestedCount: 6,
    wishlistCount: 12,
  ...
  static const myDesk = Item(
    id: 'i_desk',
    ownerId: 'u_me',
    titleAr: 'مكتب خشب زان مع كرسي',
    titleEn: 'Beech wood desk with chair',
    ...
    countryCode: 'EG',
    cityId: 'cairo',
    descriptionAr: 'مكتب متين ومساحته كبيرة. الكرسي جلد.',
    descriptionEn: 'Solid, large surface. Leather chair included.',
    photoCount: 2,
    imageSeed: 13,
    interestedCount: 3,
    wishlistCount: 5,
  ...
  static const iphone = Item(
    id: 'i_iphone',
    ownerId: 'u_ahmed',
    titleAr: 'آيفون 15 برو 256 جيجا',
    titleEn: 'iPhone 15 Pro 256GB',
    categoryId: 'mobiles',
    ...
    brand: 'Apple',
    model: 'iPhone 15 Pro',
    descriptionAr: 'بطارية 94%. بالعلبة والشاحن. مفيش أي خدوش.',
    descriptionEn: 'Battery 94%. Boxed with charger. No scratches.',
    photoCount: 5,
    imageSeed: 21,
    interestedCount: 42,
    wishlistCount: 96,
  ...
  static const macbook = Item(
    ...
    descriptionAr: 'استعمال سنة واحدة. الشاشة نظيفة والبطارية ممتازة.',
    descriptionEn: 'One year of use. Clean screen, excellent battery.',
    photoCount: 4,
    imageSeed: 22,
    interestedCount: 27,
    wishlistCount: 64,
  ...
  static const camera = Item(
    id: 'i_camera',
    ownerId: 'u_ahmed',
    titleAr: 'كاميرا سوني A7 III بودي',
    titleEn: 'Sony A7 III body',
    categoryId: 'cameras',
    subCategoryId: 'dslr',
    condition: ItemCondition.good,
    status: ItemStatus.available,
    ...
    brand: 'Sony',
    model: 'A7 III',
    descriptionAr: 'شاتر 24 ألف. بالبطاريتين والشنطة.',
    descriptionEn: 'Shutter count 24k. Two batteries and a bag included.',
    photoCount: 6,
    imageSeed: 23,
    interestedCount: 19,
    wishlistCount: 51,
  ...
  static const watch = Item(
    ...
    brand: 'Apple',
    model: 'Watch S9 45mm',
    descriptionAr: 'مستعملة شهرين بس. بكل الملحقات.',
    descriptionEn: 'Two months of use. All accessories included.',
    photoCount: 3,
    imageSeed: 24,
    interestedCount: 8,
    wishlistCount: 22,
  ...
  static const designService = Item(
    id: 'i_design',
    ownerId: 'u_mona',
    titleAr: 'تصميم هوية بصرية كاملة',
    titleEn: 'Full brand identity design',
    categoryId: 'services',
    ...
    countryCode: 'EG',
    cityId: 'alex',
    descriptionAr: 'لوجو + ألوان + خطوط + بروفايل. بقايضها بتصوير منتجات أو صيانة لابتوب.',
    descriptionEn: 'Logo, palette, type and profile. Trading for product photography or laptop repair.',
    photoCount: 4,
    imageSeed: 25,
    interestedCount: 11,
    wishlistCount: 7,
  ...
  static const sofa = Item(
    id: 'i_sofa',
    ownerId: 'u_mona',
    titleAr: 'أنتريه مودرن 3 قطع',
    titleEn: 'Modern 3-piece sofa set',
    categoryId: 'furniture',
